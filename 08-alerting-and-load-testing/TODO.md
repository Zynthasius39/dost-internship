...
## Task addımları
1. `PrometheusRule` manifesti yaradın və daxilində bu alert-ləri təyin edin:
    * **HighErrorRate**: error rate 5%-dən artıq olarsa və 2 dəqiqə davam edərsə.
    * **HighLatency**: P99 latency 500ms-dən artıq olarsa və 5 dəqiqə davam edərsə.
    * **PodCrashLooping**: pod restart rate sıfırdan böyük olarsa və 5 dəqiqə davam edərsə.
